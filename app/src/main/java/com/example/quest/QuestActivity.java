...
public class QuestActivity extends AppCompatActivity {
    ...
    private void susaninQuest(){
        ...
        scenes.add(new Scene(
                ...
                R.drawable.boloto,
                "Польско-литовский отряд понял, что ты их обманул. Они собираються вытянуть из " +
                        "тебя информацию пытками.",
    ...
    private void dolgorukiyQuest(){
        ...
        scenes.add(new Scene(
                ...
                new String[]{"Собрать отряд и попытаться разбить кочевников", "Потратить ресурсы на строительство временных укреплений"}));
        scenes.add(new Scene(
        ...
        scenes.add(new Scene(
                ...
                new String[]{"Княжеский терем", "Ремесленные мастерские"}));
        scenes.add(new Scene(
                "Княжеский терем",
                R.drawable.bund,
